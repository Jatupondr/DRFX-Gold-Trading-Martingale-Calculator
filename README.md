...
<body>
            ...
            <form id="calculatorForm">
                <div class="grid">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="multiplier" value="1.20" step="0.01" min="1.00" max="10.00" required>
                    </div>
    ...
    <script>
        ...
        function calculate() {
            ...
            html += '<p>• <strong>จุดคุ้มทุน (Point)</strong> = ระยะที่ราคาต้อง<strong>ย้อนกลับ</strong>จากไม้ล่าสุดที่โดนลาก เพื่อให้ได้กำไรรวม = 0</p>';
